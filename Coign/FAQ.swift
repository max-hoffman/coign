...
let FAQs: [FAQ] = [
    ...
    FAQ(question: "How does your overhead percentage compare to other charity intermediaries?", answer: "We have incredibly low costs compared to non-mobile platforms (improvement by at least 30%)."),
    FAQ(question: "Why microdonations?", answer: "We aim to make the process simple and social, which means low barriers and low costs. We think that small socially motivated donations are more meaningful to the individual, but can also be incredibly impactful on society if the network grows large enough."),
